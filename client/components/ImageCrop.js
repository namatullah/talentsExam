    ...
    return (
        <Dialog open={true} fullWidth>
                ...
                <Grid container spacing={2}>
                    ...
                    {src && (
                        <>
                            ...
                            <Grid item xs={12}>
                                <Button variant="outlined" fullWidth startIcon={<CropIcon />} onClick={cropImageNow}>
                                    Crop
                                </Button>
                            </Grid>
                        </>
            ...
            <DialogActions style={{ padding: '0 25px 20px 20px' }}>
                <Button variant="contained" size="small" onClick={submitPhoto}>
                    Done
                </Button>
                <Button variant="contained" size="small" color="error" onClick={() => setOpenCrop(false)}>
                    Cancel
                </Button>
            </DialogActions>
        </Dialog>
